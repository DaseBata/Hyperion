    ...
    public int[][] futuresCases(Personnage[][] plateau){
        ...
        if (this.couleur.equals("B")) {
            ...
            if ((this.ligne + 1 < 17) && (this.colonne + 1 < 17)){
                if(plateau[this.ligne+1][this.colonne+1].name.substring(plateau[this.ligne+1][this.colonne+1].name.length()-1).equals("R") || plateau[this.ligne+1][this.colonne+1].name.substring(plateau[this.ligne+1][this.colonne+1].name.length()-1).equals("J") || plateau[this.ligne+1][this.colonne+1].name.equals("_____")){
                    i++;
                }
            }
            ...
            if ((this.ligne - 1 >= 0) && (this.colonne + 1 < 17)){
                if(plateau[this.ligne-1][this.colonne+1].name.substring(plateau[this.ligne-1][this.colonne+1].name.length()-1).equals("B") || plateau[this.ligne-1][this.colonne+1].name.substring(plateau[this.ligne-1][this.colonne+1].name.length()-1).equals("V") || plateau[this.ligne-1][this.colonne+1].name.equals("_____")){
                    i++;
                }
            }
